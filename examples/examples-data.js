...
export const examples = [
  ...
  },
  {
    ...
    textureId: "STARBURST",
    previewTime: 1.0,
    config: {"duration":1.2,"looping":true,"startLifetime":{"min":0.8,"max":1.5},"startSpeed":{"min":1.5,"max":3.5},"startSize":{"min":12,"max":25},"startOpacity":{"min":0.9,"max":1},"startRotation":{"min":0,"max":360},"startColor":{"min":{"r":1,"g":0.6,"b":0.1},"max":{"r":1,"g":0.9,"b":0.3}},"gravity":1.2,"maxParticles":60,"emission":{"rateOverTime":0,"bursts":[{"time":0,"count":{"min":25,"max":40},"cycles":1,"interval":0,"probability":1}]},"shape":{"shape":"SPHERE","sphere":{"radius":0.2}},"renderer":{"blending":"THREE.AdditiveBlending"},"sizeOverLifetime":{"isActive":true,"lifetimeCurve":{"bezierPoints":[{"x":0,"y":0.5,"percentage":0},{"x":0.15,"y":1},{"x":0.4,"y":0.85,"percentage":0.4},{"x":0.7,"y":0.5},{"x":1,"y":0,"percentage":1}]}},"colorOverLifetime":{"isActive":true,"r":{"bezierPoints":[{"x":0,"y":1,"percentage":0},{"x":0.3,"y":1},{"x":0.6,"y":0.8,"percentage":0.6},{"x":0.85,"y":0.5},{"x":1,"y":0.3,"percentage":1}]},"g":{"bezierPoints":[{"x":0,"y":0.9,"percentage":0},{"x":0.2,"y":0.6},{"x":0.5,"y":0.3,"percentage":0.5},{"x":0.75,"y":0.15},{"x":1,"y":0.05,"percentage":1}]},"b":{"bezierPoints":[{"x":0,"y":0.3,"percentage":0},{"x":0.15,"y":0.1},{"x":0.4,"y":0.05,"percentage":0.4},{"x":0.7,"y":0.02},{"x":1,"y":0,"percentage":1}]}},"opacityOverLifetime":{"isActive":true,"lifetimeCurve":{"bezierPoints":[{"x":0,"y":1,"percentage":0},{"x":0.2,"y":1},{"x":0.5,"y":0.9,"percentage":0.5},{"x":0.8,"y":0.5},{"x":1,"y":0,"percentage":1}]}},"rotationOverLifetime":{"isActive":true,"min":-120,"max":120},"noise":{"isActive":true,"useRandomOffset":true,"strength":0.25,"frequency":0.4,"positionAmount":0.4,"rotationAmount":2},"subEmitters":[{"trigger":"DEATH","textureId":"SOFT_SMOKE","config":{"duration":2.5,"looping":false,"startLifetime":{"min":1,"max":2},"startSpeed":{"min":0.05,"max":0.25},"startSize":{"min":20,"max":40},"startOpacity":{"min":0.6,"max":0.85},"startRotation":{"min":-180,"max":180},"startColor":{"min":{"r":0.6,"g":0.35,"b":0.15},"max":{"r":0.8,"g":0.5,"b":0.2}},"gravity":-0.15,"maxParticles":15,"emission":{"rateOverTime":20},"shape":{"shape":"SPHERE","sphere":{"radius":0.05}},"renderer":{"blending":"THREE.AdditiveBlending"},"sizeOverLifetime":{"isActive":true,"lifetimeCurve":{"bezierPoints":[{"x":0,"y":0.3,"percentage":0},{"x":0.15,"y":0.6},{"x":0.4,"y":0.85,"percentage":0.4},{"x":0.7,"y":1},{"x":1,"y":1,"percentage":1}]}},"colorOverLifetime":{"isActive":true,"r":{"bezierPoints":[{"x":0,"y":0.8,"percentage":0},{"x":0.3,"y":0.6},{"x":0.6,"y":0.4,"percentage":0.6},{"x":0.85,"y":0.25},{"x":1,"y":0.15,"percentage":1}]},"g":{"bezierPoints":[{"x":0,"y":0.5,"percentage":0},{"x":0.3,"y":0.35},{"x":0.6,"y":0.2,"percentage":0.6},{"x":0.85,"y":0.12},{"x":1,"y":0.08,"percentage":1}]},"b":{"bezierPoints":[{"x":0,"y":0.2,"percentage":0},{"x":0.3,"y":0.1},{"x":0.6,"y":0.05,"percentage":0.6},{"x":0.85,"y":0.02},{"x":1,"y":0,"percentage":1}]}},"opacityOverLifetime":{"isActive":true,"lifetimeCurve":{"bezierPoints":[{"x":0,"y":0.7,"percentage":0},{"x":0.1,"y":1},{"x":0.35,"y":0.9,"percentage":0.35},{"x":0.65,"y":0.6},{"x":1,"y":0,"percentage":1}]}},"rotationOverLifetime":{"isActive":true,"min":-25,"max":25},"noise":{"isActive":true,"useRandomOffset":true,"strength":0.2,"frequency":0.3,"positionAmount":0.25,"rotationAmount":1.5,"sizeAmount":0.1}},"maxInstances":25}]},
  },
];
